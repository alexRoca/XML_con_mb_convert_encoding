<?php
	...
	echo 'CREACIÓN DE XML USANDO mb_convert_encoding CON UTF-8 <br><br><br><br>';
	
	echo '* lectura de matriz de datos que puede proceder de cualquier fuente <br>';
	$matrizDeObras = array(
		array(
	...
	echo '* Convertimos la matriz a una cadena con formato XML <br>';
	...
	echo '* Nos aseguramos de que la cadena que contiene el XML esté en UTF-8 <br>';
	...
	echo '* Grabamos el XML en el servidor como un fichero plano <br>';
